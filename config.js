...
const CONFIG = {
  ...
  wedding: {
    ...
    venue: "스카이컨벤션웨딩홀",
    hall: "스카이홀 4층",
    address: "강원특별자치도 춘천시 동면 춘천순환로 770",
    tel: "033-254-1000"
  },
  ...
  // ── 5. 오시는 길 ──
  mapLinks: {
    kakao: "https://kko.to/ujsJjcXwi4",
    naver: "https://naver.me/5BcF56FV"
  },
  ...
  accounts: {
    ...
    bride: [
      ...
      { role: "아버지", name: "이근철", bank: "기업은행", number: "000-000-000000" },
      { role: "어머니", name: "장미옥", bank: "농협은행", number: "000-000-000000" }
    ]
  },
  ...
  meta: {
    title: "안석순 ♥ 이현아 결혼합니다",
    description: "2027년 11월 6일, 소중한 분들을 초대합니다."
  }
};
